 ...
 */
final class Version20220123154625 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__certificate_authority AS SELECT id, comment, public_key, revoked_at, created_at, updated_at, identifier FROM certificate_authority');
        $this->addSql('DROP TABLE certificate_authority');
        $this->addSql('CREATE TABLE certificate_authority (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, comment CLOB NOT NULL COLLATE BINARY, public_key CLOB NOT NULL COLLATE BINARY, revoked_at DATETIME DEFAULT NULL --(DC2Type:datetime_immutable)
        , created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , updated_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , identifier BLOB NOT NULL --(DC2Type:ulid)
        , last_issued_serial_number BIGINT NOT NULL)');
        $this->addSql('INSERT INTO certificate_authority (id, comment, public_key, revoked_at, created_at, updated_at, identifier) SELECT id, comment, public_key, revoked_at, created_at, updated_at, identifier FROM __temp__certificate_authority');
        ...
        $this->addSql('CREATE TABLE host_certificate (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, certificate_authority_id INTEGER NOT NULL, host_id INTEGER NOT NULL, content CLOB NOT NULL COLLATE BINARY, public_key CLOB NOT NULL COLLATE BINARY, revoked_at DATETIME DEFAULT NULL --(DC2Type:datetime_immutable)
        ...
        , created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , updated_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , CONSTRAINT FK_58E8F1B4997CC58F FOREIGN KEY (certificate_authority_id) REFERENCES certificate_authority (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_58E8F1B41FB8D185 FOREIGN KEY (host_id) REFERENCES host (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE INDEX IDX_58E8F1B41FB8D185 ON host_certificate (host_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__certificate_authority AS SELECT id, comment, identifier, public_key, revoked_at, created_at, updated_at FROM certificate_authority');
        $this->addSql('DROP TABLE certificate_authority');
        $this->addSql('CREATE TABLE certificate_authority (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, comment CLOB NOT NULL, identifier BLOB NOT NULL, public_key CLOB NOT NULL, revoked_at DATETIME DEFAULT NULL --(DC2Type:datetime_immutable)
        , created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , updated_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        )');
        $this->addSql('INSERT INTO certificate_authority (id, comment, identifier, public_key, revoked_at, created_at, updated_at) SELECT id, comment, identifier, public_key, revoked_at, created_at, updated_at FROM __temp__certificate_authority');
        $this->addSql('DROP TABLE __temp__certificate_authority');
        $this->addSql('DROP INDEX IDX_CF2713FD55B127A4');
        ...
        $this->addSql('CREATE INDEX IDX_CF2713FD55B127A4 ON host (added_by_id)');
        $this->addSql('DROP INDEX IDX_58E8F1B4997CC58F');
        $this->addSql('DROP INDEX IDX_58E8F1B41FB8D185');
        $this->addSql('CREATE TEMPORARY TABLE __temp__host_certificate AS SELECT id, certificate_authority_id, content, public_key, revoked_at, serial_number, valid_from, valid_until, created_at, updated_at FROM host_certificate');
        $this->addSql('DROP TABLE host_certificate');
