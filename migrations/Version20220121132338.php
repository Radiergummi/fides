 ...
 */
final class Version20220121132338 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , display_name VARCHAR(255) NOT NULL COLLATE BINARY, fully_qualified_name VARCHAR(255) NOT NULL COLLATE BINARY, ipv4_address BLOB DEFAULT NULL, ipv6_address BLOB DEFAULT NULL, last_contacted_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
