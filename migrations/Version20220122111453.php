 ...
 */
final class Version20220122111453 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE auth_connector (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, authorize_uri VARCHAR(255) NOT NULL, client_id VARCHAR(255) NOT NULL, client_secret VARCHAR(255) NOT NULL, enabled BOOLEAN NOT NULL, provider VARCHAR(255) NOT NULL --(DC2Type:App\\Entity\\Enum\\AuthConnectorProvider)
        , redirect_uri VARCHAR(255) NOT NULL, token_uri VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE auth_connector');
        $this->addSql('DROP INDEX IDX_CF2713FD55B127A4');
